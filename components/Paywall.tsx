      ...
      <div className="relative w-full max-w-md bg-slate-900 border border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden shadow-orange-500/10 ring-1 ring-white/10 animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 flex flex-col items-center text-center">
          ...
          <button
            ...
            className="w-full bg-white/5 border border-white/10 hover:bg-white/10 text-slate-300 font-bold py-4 rounded-3xl transition-all active:scale-[0.98] mb-4 text-center text-xs"
          >
            🚀 COMPARTILHAR APP
          </button>
